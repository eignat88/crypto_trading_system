...
| Стратегия Trend DCA | ✅ Готово | `app/strategies/trend_dca.py` |
...
- [ ] Подключить Trend DCA к BacktestEngine
...
### T14: Вторая стратегия — Grid
- [ ] Реализовать `app/strategies/grid_strategy.py`
- [ ] Условия запуска: RANGE режим, допустимая волатильность
- [ ] Параметры: границы, количество уровней, размер ордера
- [ ] Автоотключение при переходе в тренд
- [ ] Интеграция с backtest

**Результат**: Вторая стратегия протестирована
