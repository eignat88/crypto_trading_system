...
Usage:
    python scripts/backtest_trend_following.py
    python scripts/backtest_trend_following.py --balance 1000
    python scripts/backtest_trend_following.py --symbol ETHUSDT
"""
...
async def run_backtest(balance: Decimal, symbol: str) -> None:
    ...
    from app.strategies.trend_following import TrendFollowingConfig, TrendFollowingStrategy
    ...
    print("=" * 60)
    print(f"BACKTEST: Trend Following — {symbol}")
    print("=" * 60)
    ...
    strategy = TrendFollowingStrategy([symbol], config=config)
    ...
    report_path = PROJECT_ROOT / "artifacts" / f"backtest_{symbol.lower()}_trend_following.json"
